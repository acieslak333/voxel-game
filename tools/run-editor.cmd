...
REM   Usage:  run-editor.cmd [hub^|genmap^|biome^|recipe^|particle]   (default: hub)
REM Ports:  hub 5005 . genmap 5000 . particle 5001 . biome 5002 . recipe 5003
...
if /i "%NAME%"=="genmap"    set "SCRIPT=tools\genmap_tool.py"
if /i "%NAME%"=="world"     set "SCRIPT=tools\genmap_tool.py"
if /i "%NAME%"=="worldgen"  set "SCRIPT=tools\genmap_tool.py"
if /i "%NAME%"=="biome"     set "SCRIPT=tools\biome_tool.py"
if /i "%NAME%"=="flora"     set "SCRIPT=tools\biome_tool.py"
