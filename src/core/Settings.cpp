...
Settings Settings::load(const std::string& path) {
    ...
    get("bloom", s.bloom);
    get("bloomIntensity", s.bloomIntensity);
    get("bloomThreshold", s.bloomThreshold);
    get("bloomRadius", s.bloomRadius);
    get("godrays", s.godrays);
    get("godrayStrength", s.godrayStrength);
    get("godrayLength", s.godrayLength);
    get("godrayDecay", s.godrayDecay);
    get("retroJitter", s.retroJitter);
...
void Settings::save(const std::string& path) const {
    ...
    root["bloom"]          = bloom;
    root["bloomIntensity"] = bloomIntensity;
    root["bloomThreshold"] = bloomThreshold;
    root["bloomRadius"]    = bloomRadius;
    root["godrays"]        = godrays;
    root["godrayStrength"] = godrayStrength;
    root["godrayLength"]   = godrayLength;
    root["godrayDecay"]    = godrayDecay;
    root["retroJitter"]    = retroJitter;
