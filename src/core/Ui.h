...
// Which 9-patch UI sprite to draw (see assets/textures/ui_*.block.png, generated by
// scripts/gen_ui.py). Maps to a texture-array layer via the registry's UiSpriteLayers.
